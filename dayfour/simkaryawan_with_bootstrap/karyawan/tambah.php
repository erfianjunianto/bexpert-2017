...
<main>
	...
	if(isset($_POST['submit'])){
		...
		if(empty($nama)){
			...
			$query = "INSERT INTO karyawan (nama, email, telpon, jabatan, jeniskelamin, divisiid, tgllahir) VALUES ('$nama', '$email','$telpon','$jabatan','$jeniskelamin','$divisiid','$tgllahir')";
		...
		<div class="col-sm-12">
			<form action="" method="post" accept-charset="utf-8" name="formtambah" id="formtambah" class="form-horizontal col-sm-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="tgllahir" id="tgllahir" class="form-control datepicker" value="2014-01-01" data-default-today="true" data-date-format="DD-MM-YYYY" required="required">
					</div>
				</div>
				<div class="form-group">
