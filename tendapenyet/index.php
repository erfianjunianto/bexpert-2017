    ...
    <div class="row" id="pilihmeja">
        ...
        $("#datamakanan").change(function () {
            ...
            for (var i = 0; i < makananids.length; i++) {
                html += '<label class="control-label col-sm-4">' + makananids[i] + '</label><div class="form-group"><input type="hidden" name="makanan[]" value="'+makananids[i]+'" size="30" required="required"><input type="text" name="jumlah[]" value="1" size="30" required="required"></div>';
            }
